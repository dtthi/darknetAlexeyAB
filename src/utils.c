...
void replace_image_to_label(const char* input_path, char* output_path)
{
    ...
    find_replace(output_path, "crowdHumanTrain", "crowdHumanTrainLabel", output_path);        // crowdHuman
    find_replace(output_path, "crowdHumanVal", "crowdHumanValLabel", output_path);        // crowdHuman
